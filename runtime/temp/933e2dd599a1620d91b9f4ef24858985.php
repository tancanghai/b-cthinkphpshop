<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:110:"D:\PhpStudy\phpstudy_install_dir\PHPTutorial\WWW\thinkphpbcshop\public/../application/admin\view\cate\add.html";i:1613693134;s:105:"D:\PhpStudy\phpstudy_install_dir\PHPTutorial\WWW\thinkphpbcshop\application\admin\view\common\header.html";i:1607246384;}*/ ?>
<!DOCTYPE html>
<!--
                ...
                <form id="togglingForm" class="form-horizontal" role="form" enctype="multipart/form-data"  method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            <label>
                                <input name="show_nav" type="radio" class="colored-blue" value="<?php echo \think\Config::get('cost.SHOWNAVHAVE')['VAL']; ?>" checked="checked">
                                <span class="text"><?php echo \think\Config::get('cost.SHOWNAVHAVE')['DESC']; ?></span>
                            </label>
                        </div>
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            <label>
                                <input name="show_nav" type="radio" class="colored-danger" value="<?php echo \think\Config::get('cost.SHOWNAVNONE')['VAL']; ?>">
    ...
    $(function () {
        ...
        $("#submit").on("click", function(){
            ...
            if(bootstrapValidator.isValid()){
                ...
                $.post("<?php echo url('cate/save_cate_add'); ?>", thisData, function (callback) {
