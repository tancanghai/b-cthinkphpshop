<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:114:"D:\PhpStudy\phpstudy_install_dir\PHPTutorial\WWW\thinkphpbcshop\public/../application/admin\view\article\edit.html";i:1613921704;s:105:"D:\PhpStudy\phpstudy_install_dir\PHPTutorial\WWW\thinkphpbcshop\application\admin\view\common\header.html";i:1607246384;}*/ ?>
<!DOCTYPE html>
<!--
                ...
                <form id="togglingForm" class="form-horizontal" role="form" enctype="multipart/form-data"  method="post">
                    <div class="form-group">
                        ...
                        <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                            <select id="cate_id" style="width:100%;" name="cate_id">
                                ...
                                <option  value="<?php echo $v['cate_id']; ?>" <?php if(($v['cate_id'] == $article_data['cate_id'])): ?>selected<?php endif; ?>/><?php echo $v['cate_name']; endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                            <input type="text" class="form-control" id="title" placeholder="标题" name="title" value="<?php echo $article_data['title']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="author" class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label no-padding-right">作者</label>
                        <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                            <input type="text" class="form-control" id="author" placeholder="作者" name="author" value="<?php echo $article_data['author']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="keywords" class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label no-padding-right">关键词</label>
                        <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                            <input type="text" class="form-control" id="keywords" placeholder="关键词" name="keywords" value="<?php echo $article_data['keywords']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label no-padding-right">邮箱</label>
                        <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                            <input type="text" class="form-control" id="email" placeholder="邮箱" name="email" value="<?php echo $article_data['email']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="link_url" class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label no-padding-right">跳转链接</label>
                        <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                            <input type="text" class="form-control" id="link_url" placeholder="跳转链接" name="link_url" value="<?php echo $article_data['link_url']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            <label>
                                <input name="show_status" type="radio" class="colored-blue" value="<?php echo \think\Config::get('cost.SHOWSTATUSHAVE')['VAL']; ?>" <?php if(($article_data['show_status'] == \think\Config::get('cost.SHOWSTATUSHAVE')['VAL'])): ?> checked="checked" <?php endif; ?>>
                                <span class="text"><?php echo \think\Config::get('cost.SHOWSTATUSHAVE')['DESC']; ?></span>
                            </label>
                        </div>
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            <label>
                                <input name="show_status" type="radio" class="colored-danger" value="<?php echo \think\Config::get('cost.SHOWSTATUSNONE')['VAL']; ?>" <?php if(($article_data['show_status'] == \think\Config::get('cost.SHOWSTATUSNONE')['VAL'])): ?> checked="checked" <?php endif; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            <label>
                                <input name="show_top" type="radio" class="colored-blue" value="<?php echo \think\Config::get('cost.SHOWTOPHAVE')['VAL']; ?>" <?php if(($article_data['show_top'] == \think\Config::get('cost.SHOWTOPHAVE')['VAL'])): ?> checked="checked" <?php endif; ?>>
                                <span class="text"><?php echo \think\Config::get('cost.SHOWTOPHAVE')['DESC']; ?></span>
                            </label>
                        </div>
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            <label>
                                <input name="show_top" type="radio" class="colored-danger" value="<?php echo \think\Config::get('cost.SHOWTOPNONE')['VAL']; ?>" <?php if(($article_data['show_top'] == \think\Config::get('cost.SHOWTOPNONE')['VAL'])): ?> checked="checked" <?php endif; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                            <textarea class="form-control" rows="3" placeholder="描述" name="description"><?php echo $article_data['description']; ?></textarea>
                        </div>
                    </div>
                            ...
                            <script type="text/javascript">
                                var ue = UE.getEditor('container',{
                                    toolbars: [[
                                        ...
                                        'simpleupload', 'insertimage', 'emotion', 'webapp', 'pagebreak', 'template', 'background', '|',
    ...
    $(function () {
        ...
        $("#submit").on("click", function(){
            ...
            if(bootstrapValidator.isValid()){
                ...
                let id = "<?php echo $article_data['article_id']; ?>";
                $.post("<?php echo url('article/save_article_edit'); ?>", {"data":thisData,"id":id}, function (callback) {
